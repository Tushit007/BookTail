const sampleListings = [
  ...
  {
    title: "Cottage by the Lavender Fields",
    description: "Wake up to the scent of lavender in this peaceful countryside cottage nestled in Provence.",
    image: {
      filename: "listingimage",
  ...
  {
    title: "Floating Bungalow in Bora Bora",
    description: "Enjoy overwater luxury in this romantic floating bungalow with crystal-clear lagoon access.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Enjoy rustic charm with modern amenities in this peaceful farmhouse surrounded by rolling hills.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Experience the magic of staying in a luxurious cave carved into volcanic rock with ocean views.",
    image: {
      filename: "listingimage",
